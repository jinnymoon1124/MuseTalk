...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            extra_margin = gr.Slider(label="Extra Margin", minimum=0, maximum=400, value=0, step=1)
            parsing_mode = gr.Radio(label="Parsing Mode", choices=["jaw", "raw"], value="jaw")
            left_cheek_width = gr.Slider(label="Left Cheek Width", minimum=0, maximum=200, value=20, step=1)
            right_cheek_width = gr.Slider(label="Right Cheek Width", minimum=0, maximum=200, value=20, step=1)
        ...
        with gr.Column():
            ...
            debug_info = gr.Textbox(label="Parameter Information", lines=8)
            out1 = gr.Video()
